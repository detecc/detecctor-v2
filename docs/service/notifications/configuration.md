...
Before the Detecctor Notification Service is run, it _must_ have a configuration file set up. The attributes, required
to successfully run the service, are:

1. mqttBroker information
2. bot token and bot type
